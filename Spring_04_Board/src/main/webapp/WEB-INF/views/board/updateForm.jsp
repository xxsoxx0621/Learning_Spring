...
<body>
		...
		<div class="container">
		  <c:forEach var="i" items="${seqList }">
			<div id="subject">
				<input type="text" placeholder="제목을 입력하세요." id="title" value="${i.title }" readonly>
			</div>
			...
			<c:when test="${loginID == i.writer }">
				<div class="btns">
					...
					<button id="delete" class="btn btn-primary" onclick="delete()" type="button" hidden>수정완료</button>
